...
class RecordState extends State<RecordPage>
  ...
  Color _mainColor = Colours.normalBlue;
                      ...
                      child: RadioListTile(
                          title: Text(_payChannels[index].desc,
                              style: TextStyle(
                                  fontSize: Adaptor.px(32.0),
                                  color: AppColors.appTextDark)),
                          activeColor: Colours.normalBlue,
                          value: index,
  ...
  void _createBill(type) async {
    ...
    if (type == 'income') {
      if (_incomeInputController.text.length == 0) {
        BotToast.showText(text: '收入金额不能为空');
        return;
      }
      ...
      _bill = {
        ...
        'billDate': _billDate,
        'remark': _incomeMarkController.text
      };
    } else {
  ...
  Widget _buildPayment(BuildContext context) {
    return SingleChildScrollView(
      ...
      children: <Widget>[
        Container(
          decoration: BoxDecoration(color: Colours.normalBlue),
          child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: '请输入支出金额',
                  fillColor: Colours.normalBlue,
                  filled: true,
                  hintStyle: TextStyle(color: AppColors.appWhite),
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(
                        color: AppColors.appWhite, width: Adaptor.onePx()),
                  ),
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('记账',
              style: TextStyle(
                  fontSize: Adaptor.px(32.0), color: AppColors.appWhite)),
